            ...
            <hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
                <div class="sm:flex sm:items-center sm:justify-between">
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <a href="https://www.instagram.com/cyprien.rimbaud/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <a href="https://github.com/sidarzo" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
